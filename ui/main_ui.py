...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_I2C = QtWidgets.QPushButton(self.centralwidget)
        self.btn_I2C.setMinimumSize(QtCore.QSize(80, 30))
        self.btn_I2C.setObjectName("btn_I2C")
        self.verticalLayout.addWidget(self.btn_I2C)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_I2C.setText(_translate("MainWindow", "I2C"))
