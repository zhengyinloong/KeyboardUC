# KeyboardUC
FIND 8 DEVICES
DEVICE ID 8087:0aaa on Bus 001 Address 004 =================
    ...
    INTERFACE 1, 6: Wireless Controller ====================
     ...
     iInterface         :    0x0 
      ...
      ENDPOINT 0x83: Isochronous IN ========================
       ...
       wMaxPacketSize   :   0x3f (63 bytes)
       bInterval        :    0x1
DEVICE ID 04f2:b6ee on Bus 001 Address 002 =================
 bLength                :   0x12 (18 bytes)
 bDescriptorType        :    0x1 Device
 ...
 idVendor               : 0x04f2
 idProduct              : 0xb6ee
 bcdDevice              : 0x2721 Device 39.21
 iManufacturer          :    0x3 Error Accessing String
 iProduct               :    0x1 Error Accessing String
 iSerialNumber          :    0x2 Error Accessing String
 bNumConfigurations     :    0x1
  CONFIGURATION 1: 500 mA ==================================
   bLength              :    0x9 (9 bytes)
   bDescriptorType      :    0x2 Configuration
   wTotalLength         :  0x368 (872 bytes)
   bNumInterfaces       :    0x2
   bConfigurationValue  :    0x1
    ...
    INTERFACE 1, 4: Video ==================================
     ...
     iInterface         :    0x0 
      ENDPOINT 0x81: Isochronous IN ========================
       ...
       bEndpointAddress :   0x81 IN
       bmAttributes     :    0x5 Isochronous
       wMaxPacketSize   :  0xb00 (2816 bytes)
       bInterval        :    0x1
    INTERFACE 1, 5: Video ==================================
     bLength            :    0x9 (9 bytes)
     bDescriptorType    :    0x4 Interface
    ...
    INTERFACE 1, 6: Video ==================================
     ...
     iInterface         :    0x0 
      ENDPOINT 0x81: Isochronous IN ========================
       ...
       bEndpointAddress :   0x81 IN
       bmAttributes     :    0x5 Isochronous
       wMaxPacketSize   : 0x1380 (4992 bytes)
       bInterval        :    0x1
    INTERFACE 1, 7: Video ==================================
     bLength            :    0x9 (9 bytes)
     bDescriptorType    :    0x4 Interface
     ...
     iInterface         :    0x0 
      ENDPOINT 0x81: Isochronous IN ========================
       ...
       bInterval        :    0x1
DEVICE ID 25a7:fa23 on Bus 001 Address 005 =================
 bLength                :   0x12 (18 bytes)
 bDescriptorType        :    0x1 Device
 ...
 idVendor               : 0x25a7
 idProduct              : 0xfa23
 bcdDevice              :  0x241 Device 2.41
 iManufacturer          :    0x1 Compx
 iProduct               :    0x2 2.4G Receiver
 iSerialNumber          :    0x0 
 bNumConfigurations     :    0x1
  CONFIGURATION 1: 100 mA ==================================
   bLength              :    0x9 (9 bytes)
    ...
    INTERFACE 1: Human Interface Device ====================
     ...
     iInterface         :    0x0 
      ENDPOINT 0x82: Interrupt IN ==========================
       ...
       wMaxPacketSize   :    0x8 (8 bytes)
       bInterval        :    0x2
DEVICE ID 8086:34ed on Bus 001 Address 000 =================
 bLength                :   0x12 (18 bytes)
 bDescriptorType        :    0x1 Device
    ...
    INTERFACE 0: Hub =======================================
     ...
     iInterface         :    0x0 
      ENDPOINT 0x81: Interrupt IN ==========================
       ...
       bInterval        :    0xc
DEVICE ID 8086:8a13 on Bus 002 Address 000 =================
 bLength                :   0x12 (18 bytes)
 bDescriptorType        :    0x1 Device
 bcdUSB                 :  0x300 USB 3.0
 bDeviceClass           :    0x9 Hub
    ...
    INTERFACE 0: Hub =======================================
     ...
     iInterface         :    0x0 
      ENDPOINT 0x81: Interrupt IN ==========================
       ...
       bInterval        :    0xc
DEVICE ID 0d00:0721 on Bus 001 Address 011 =================
 bLength                :   0x12 (18 bytes)
 bDescriptorType        :    0x1 Device
 bcdUSB                 :  0x200 USB 2.0
 bDeviceClass           :    0x0 Specified at interface
 ...
 idProduct              : 0x0721
 bcdDevice              :  0x100 Device 1.0
 iManufacturer          :    0x1 GigaDevice
 iProduct               :    0x2 GD32-USB_Keyboard
 iSerialNumber          :    0x3 7D7E84EC0130
 bNumConfigurations     :    0x1
  CONFIGURATION 1: 100 mA ==================================
   bLength              :    0x9 (9 bytes)
   bDescriptorType      :    0x2 Configuration
   wTotalLength         :  0x11b (283 bytes)
   bNumInterfaces       :    0x6
   bConfigurationValue  :    0x1
   iConfiguration       :    0x0 
   bmAttributes         :   0xa0 Bus Powered, Remote Wakeup
    ...
    INTERFACE 2, 1: Audio ==================================
     ...
     iInterface         :    0x0 
      ...
      ENDPOINT 0x4: Isochronous OUT ========================
       ...
       wMaxPacketSize   :   0x20 (32 bytes)
       bInterval        :    0x1
DEVICE ID 04f3:0c4d on Bus 001 Address 003 =================
 bLength                :   0x12 (18 bytes)
 bDescriptorType        :    0x1 Device
 bcdUSB                 :  0x200 USB 2.0
 bDeviceClass           :    0x0 Specified at interface
    ...
    INTERFACE 0: Vendor Specific ===========================
     ...
     iInterface         :    0x0 
      ...
      ENDPOINT 0x3: Bulk OUT ===============================
       ...
       wMaxPacketSize   :   0x40 (64 bytes)
       bInterval        :    0x1
DEVICE ID 1d6b:0000 on Bus 003 Address 000 =================
 bLength                :   0x12 (18 bytes)
 bDescriptorType        :    0x1 Device
 bcdUSB                 :  0x110 USB 1.1
 bDeviceClass           :    0x9 Hub
